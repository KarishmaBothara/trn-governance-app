import svgPaths from "./svg-gcdj470uuv";
...
function DashboardSearch() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start p-0 top-[574px] w-[1220px]"
...
function DashboardInfo() {
  return (
    <div
      className="absolute bg-[#1b1b1b] h-[219px] rounded-2xl top-[122px] w-[1231px]"
...
function DashboardInfo6() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-6 items-start justify-start overflow-clip p-0 rounded-2xl shadow-[0px_1px_1px_-0.5px_rgba(0,0,0,0.12),0px_3px_3px_-1.5px_rgba(0,0,0,0.12),0px_24px_24px_-12px_rgba(0,0,0,0.12)] top-[373px] w-[1231px]"
      data-name="dashboard_info"
      style={{ left: "calc(16.667% + 106px)" }}
    >
      <Frame30 />
...
function Frame34() {
  return (
    <div
      className="[flex-flow:wrap] absolute box-border content-center flex gap-7 items-center justify-start p-0 top-[646px] w-[1224px]"
      style={{ left: "calc(16.667% + 113px)" }}
    >
...
export default function Delegate() {
  return (
    <div className="bg-[#141414] relative size-full" data-name="Delegate">
      <SideBar />
      <TopNavItem />
      <TopNavItem1 />
      <DashboardSearch />
      ...
      <DashboardInfo6 />
      <div
        className="absolute font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic text-[#ffffff] text-[32px] text-left top-[521px] w-[566px]"
        style={{ left: "calc(16.667% + 113px)" }}
      >
