import svgPaths from "./svg-ra32w9wipj";
...
function TestWrap1() {
  return (
    <div
      ...
      data-name="test_wrap"
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[11px] text-[rgba(255,255,255,0.72)] text-left text-nowrap">
        <p className="block leading-[16px] whitespace-pre">Delegation</p>
      </div>
    </div>
  );
}
...
function Tags1() {
  return (
    <div
      className="bg-[#141414] box-border content-stretch flex flex-row gap-0.5 h-5 items-center justify-center overflow-clip px-1.5 py-0 relative rounded-md shrink-0"
      data-name="tags"
    >
      <TestWrap1 />
      <div className="absolute inset-0 pointer-events-none shadow-[0px_2px_3px_0px_inset_rgba(255,255,255,0.07),0px_-1px_3px_-1px_inset_rgba(255,255,255,0.07)]" />
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-3 items-center justify-start p-0 relative shrink-0">
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[15px] text-nowrap text-right">
        <p className="block leading-[normal] whitespace-pre">2,000 ROOT</p>
      </div>
...
function TestWrap2() {
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[11px] text-[rgba(255,255,255,0.72)] text-left text-nowrap">
        <p className="block leading-[16px] whitespace-pre">Voting</p>
      </div>
    </div>
  );
}
...
function TestWrap5() {
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[11px] text-[rgba(255,255,255,0.72)] text-left text-nowrap">
        <p className="block leading-[16px] whitespace-pre">Proposal</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div
      className="[flex-flow:wrap] absolute box-border content-center flex gap-6 items-center justify-start p-0 top-[500px] w-[1268px]"
...
export default function PortfolioActiveLocks() {
  return (
    <div
      className="bg-[#141414] relative size-full"
      data-name="Portfolio - Active locks"
    >
      <SideBar />
      <TopNavItem />
      <TopNavItem1 />
