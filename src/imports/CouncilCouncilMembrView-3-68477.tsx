import svgPaths from "./svg-ksu0trzmng";
...
function LeftIcon4() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="left_icon">
      ...
      >
        <g id="left_icon">
          <path d={svgPaths.p9a6800} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[26px] text-left text-nowrap">
        <p className="block leading-[32px] whitespace-pre">5</p>
      </div>
    </div>
  );
}
...
function Figures1() {
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[26px] text-left text-nowrap">
        <p className="block leading-[32px] whitespace-pre">6/19</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative w-full">
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">Runners up</p>
          </div>
          <Figures1 />
        </div>
      </div>
...
function Frame58() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Term progress</p>
      </div>
      <Figures2 />
    </div>
  );
...
function StrengthBar() {
  return (
    <div
      className="bg-[#ffffff] h-full rounded-[1000px] shrink-0 w-[278px]"
...
function Strength() {
  return (
    <div
      className="bg-[rgba(255,255,255,0.2)] box-border content-stretch flex flex-row gap-2 h-3 items-start justify-start p-0 relative rounded-xl shrink-0 w-full"
      data-name="strength"
    >
      <StrengthBar />
    </div>
...
function DashboardInfo2() {
  return (
    <div
      className="basis-0 bg-[#111111] grow min-h-px min-w-px relative rounded-2xl self-stretch shrink-0"
      data-name="dashboard_info"
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-between pb-6 pt-4 px-5 relative size-full">
          <Frame56 />
          <Strength />
        </div>
      </div>
...
function DashboardInfo3() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-6 items-start justify-start overflow-clip p-0 rounded-2xl shadow-[0px_1px_1px_-0.5px_rgba(0,0,0,0.12),0px_3px_3px_-1.5px_rgba(0,0,0,0.12),0px_24px_24px_-12px_rgba(0,0,0,0.12)] top-[257px] w-[1231px]"
      data-name="dashboard_info"
...
function Header1() {
  return (
    <div className="relative shrink-0 w-full" data-name="header">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start leading-[0] not-italic pb-3 pt-0 px-12 relative text-[#ffffff] text-left w-full">
          <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] relative shrink-0 text-[32px] text-nowrap">
            <p className="block leading-[32px] whitespace-pre">Council</p>
          </div>
          <div className="font-['Open_Sauce_Two:Regular',_sans-serif] relative shrink-0 text-[15px] w-[558px]">
  ...
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Motion pipeline</p>
      </div>
    </div>
  );
}
...
function TabNavItem2() {
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Propose motion</p>
      </div>
    </div>
  );
}
...
function NavBarHeader() {
  return (
    <div
      className="absolute bottom-[900px] box-border content-stretch flex flex-col items-start justify-start pb-0 pt-10 px-0 w-[1088px]"
      ...
      >
        <g id="shape">
          <path
            ...
            fill="url(#paint0_linear_3_52488)"
            id="Vector"
          />
          <path
            d={svgPaths.p3d9d8a80}
...
function DashboardInfo6() {
  return (
    <div
      className="bg-[#1b1b1b] relative rounded-2xl shrink-0 w-[601px]"
      data-name="dashboard_info"
    >
      <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start overflow-clip px-5 py-4 relative w-[601px]">
        <Frame2 />
...
function Frame34() {
  return (
    <div
      className="[flex-flow:wrap] absolute box-border content-center flex gap-7 items-center justify-start p-0 top-[382px] w-[1231px]"
      style={{ left: "calc(16.667% + 106px)" }}
    >
      {[...Array(5).keys()].map((_, i) => (
        <DashboardInfo6 key={i} />
      ))}
    </div>
  );
}
...
function Button1() {
  return (
    <div
      className="bg-[#141414] h-12 relative rounded-[10px] shrink-0"
      data-name="button"
    >
      <div className="box-border content-stretch flex flex-row gap-2 h-12 items-center justify-center overflow-clip px-4 py-3 relative">
        <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.72)] text-left text-nowrap">
          <p className="block leading-[24px] whitespace-pre">Resign seat</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame59() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-3.5 items-center justify-start p-0 top-[129px]"
      style={{ left: "calc(75% + 45px)" }}
    >
      <Button />
      <Button1 />
    </div>
...
export default function CouncilCouncilMembrView() {
  return (
    <div
      className="bg-[#141414] relative size-full"
      data-name="Council - Council membr view"
    >
      <SideBar />
      <TopNavItem />
      <TopNavItem1 />
