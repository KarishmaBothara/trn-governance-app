import svgPaths from "./svg-whq14c9wvp";
  ...
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Council overview</p>
      </div>
    </div>
  );
}
...
function TabNavItem3() {
  return (
    <div className="h-10 relative shrink-0" data-name="tab_nav_item">
      <div className="box-border content-stretch flex flex-row gap-2 h-10 items-center justify-center overflow-clip pb-2 pt-1 px-0.5 relative">
        <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[13px] text-left text-nowrap">
          <p className="block leading-[24px] whitespace-pre">Proposed</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function TabNavItem4() {
  return (
    ...
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Voting</p>
      </div>
    </div>
  );
}

function TabNavItem5() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2 h-10 items-center justify-center overflow-clip pb-2 pt-1 px-0.5 relative shrink-0"
      data-name="tab_nav_item"
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Passed</p>
      </div>
    </div>
  );
}

function TabNavItem6() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2 h-10 items-center justify-center overflow-clip pb-2 pt-1 px-0.5 relative shrink-0"
      data-name="tab_nav_item"
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Rejected</p>
      </div>
    </div>
  );
}
...
function NavBarHeader1() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-start justify-start pb-0 pt-10 px-0 top-[217px] w-[1268px]"
      data-name="nav_bar_header"
      style={{ left: "calc(16.667% + 69px)" }}
    >
      <Header2 />
...
function Button2() {
  return (
    <div
      className="basis-0 bg-[#141414] grow h-10 min-h-px min-w-px relative rounded-[10px] shrink-0"
      data-name="button"
    >
      <div className="flex flex-row items-center justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2 h-10 items-center justify-center px-3 py-2 relative w-full">
          <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.72)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">
              Second proposal (2/5)
            </p>
          </div>
...
function Frame4() {
  return (
    <div
      className="[flex-flow:wrap] absolute box-border content-center flex gap-6 items-center justify-start p-0 top-[388px] w-[1268px]"
