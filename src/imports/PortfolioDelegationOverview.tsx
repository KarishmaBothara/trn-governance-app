import svgPaths from "./svg-hbp1fmz6e7";
...
function DashboardInfo5() {
  return (
    <div
      className="bg-[#111111] relative rounded-2xl shrink-0 w-[274px]"
      data-name="dashboard_info"
    >
...
function Frame43() {
  return (
    <div className="[flex-flow:wrap] box-border content-start flex gap-3 items-start justify-start p-0 relative shrink-0 w-full">
      <DashboardInfo5 />
      <DashboardInfo6 />
    </div>
  );
...
function Frame44() {
  return (
    ...
    >
      ...
      />
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[26px] text-left w-full">
...
function Frame6() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[18.574px] items-center justify-start p-0 relative shrink-0">
      <LeftIcon16 />
      <Frame31 />
    </div>
  );
...
function Frame39() {
  return (
    <div className="box-border content-stretch flex flex-col items-end justify-end p-0 relative shrink-0">
      <Frame41 />
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
...
function TextWrap2() {
  return (
    <div
      ...
      data-name="text_wrap"
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#000000] text-[12px] text-left text-nowrap">
...
function TopNavItem2() {
  return (
    <div
      className="bg-[#8d7aff] box-border content-stretch flex flex-row gap-1.5 h-8 items-center justify-center overflow-clip px-0 py-2 relative rounded-[1000px] shrink-0 w-[68px]"
      data-name="top_nav_item"
    >
      <TextWrap2 />
      <div className="absolute inset-0 pointer-events-none shadow-[0px_2px_8px_-2px_inset_rgba(255,255,255,0.56),0px_0px_8px_-2px_inset_rgba(0,0,0,0.24)]" />
...
function TextWrap4() {
  return (
    <div
      ...
      data-name="text_wrap"
    >
      <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#8c929c] text-[13px] text-left text-nowrap">
...
export default function PortfolioDelegationOverview() {
  return (
    <div
      ...
      data-name="Portfolio - Delegation Overview"
    >
      <SideBar />
      <TopNavItem />
      <TopNavItem1 />
