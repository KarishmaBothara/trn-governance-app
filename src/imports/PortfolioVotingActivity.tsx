import svgPaths from "./svg-mtnhzo3vwf";
  ...
  return (
    <div className="box-border content-stretch flex flex-col items-end justify-end p-0 relative shrink-0">
      ...
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">x6 Conviction</p>
      </div>
    </div>
  );
}
...
export default function PortfolioVotingActivity() {
  return (
    <div
      className="bg-[#141414] relative size-full"
      data-name="Portfolio - Voting activity"
    >
      <SideBar />
      <TopNavItem />
      <TopNavItem1 />
