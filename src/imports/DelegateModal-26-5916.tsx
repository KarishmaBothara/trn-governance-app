import svgPaths from "./svg-fvv5h9mctj";
...
function LeftIcon7() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="left_icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" role="presentation" viewBox="0 0 22 22">
        <g id="left_icon">
          <path d={svgPaths.p21e9c380} fill="var(--fill-0, white)" fillOpacity="0.48" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function RightIcon() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="right_icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" role="presentation" viewBox="0 0 18 18">
        <g id="right_icon">
          <path d={svgPaths.p246c6200} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function RightIcon1() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="right_icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" role="presentation" viewBox="0 0 18 18">
        <g id="right_icon">
          <path clipRule="evenodd" d={svgPaths.p1cd8c500} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#8d7aff] h-12 relative rounded-[10px] shrink-0" data-name="button">
      <div className="box-border content-stretch flex flex-row gap-2 h-12 items-center justify-center overflow-clip px-4 py-3 relative">
        <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#000000] text-[15px] text-left text-nowrap">
          <p className="block leading-[24px] whitespace-pre">Become a Delegate</p>
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none shadow-[0px_2px_8px_-2px_inset_rgba(255,255,255,0.56),0px_0px_8px_-2px_inset_rgba(0,0,0,0.24)]" />
      <div
  ...
  return (
    <div className="box-border content-stretch flex flex-row items-center justify-between p-0 relative shrink-0 w-full">
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[36px] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">How to Delegate on Root Network</p>
      </div>
      <Button />
    </div>
  );
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-3 items-start justify-start p-0 relative shrink-0 w-full">
      ...
      <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[10px] text-left w-full">
        <p className="block leading-[normal]">* You the ability to revoke delegates at any time.</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative w-full">
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">Delegated tokens</p>
          </div>
          <Figures1 />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative w-full">
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">Total delegated votes</p>
          </div>
          <Figures2 />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative w-full">
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">Total delegates</p>
          </div>
          <Figures3 />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative w-full">
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.48)] text-left text-nowrap">
            <p className="block leading-[24px] whitespace-pre">Total delegators</p>
          </div>
          <Figures4 />
        </div>
      </div>
  ...
  return (
    <div className="absolute left-0 size-[17.137px] top-0" data-name="shape">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="shape">
          <path d={svgPaths.p2bbcbd80} fill="url(#paint0_linear_26_7174)" id="Vector" />
          <path d={svgPaths.p42e5f80} fill="var(--fill-0, black)" id="Vector_2" />
        </g>
        <defs>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="paint0_linear_26_7174"
            x1="8.56854"
            x2="8.56854"
            y1="0"
            y2="17.1371"
  ...
  return (
    <div className="box-border content-stretch flex flex-col font-['Open_Sauce_Two:SemiBold',_sans-serif] items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[rgba(255,255,255,0.72)] text-left text-nowrap">
      <div className="relative shrink-0 text-[24px]">
        <p className="block leading-[24.765px] text-nowrap whitespace-pre">FV Seona</p>
      </div>
      <div className="relative shrink-0 text-[12px]">
        <p className="block leading-[16px] text-nowrap whitespace-pre">0vndh8..94803</p>
      </div>
    </div>
  );
}
...
function IconXCom() {
  return (
    <div className="relative shrink-0 size-6" data-name="icon / x.com">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / x.com">
          <path d={svgPaths.p3c3c0680} fill="var(--fill-0, white)" fillOpacity="0.72" id="Vector" />
        </g>
      </svg>
    </div>
  );
      ...
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic pb-[22px] pt-3 px-3 relative text-left text-nowrap w-full">
          <div className="font-['Open_Sauce_Two:SemiBold',_sans-serif] mb-[-10px] relative shrink-0 text-[#ffffff] text-[15px]">
            <p className="block leading-[32px] text-nowrap whitespace-pre">837K</p>
          </div>
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] mb-[-10px] relative shrink-0 text-[12px] text-[rgba(255,255,255,0.48)]">
            <p className="block leading-[24px] text-nowrap whitespace-pre">Voting power</p>
          </div>
        </div>
      </div>
      <div
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic pb-[22px] pt-3 px-3 relative text-left text-nowrap w-full">
          ...
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] mb-[-10px] relative shrink-0 text-[12px] text-[rgba(255,255,255,0.48)]">
            <p className="block leading-[24px] text-nowrap whitespace-pre">Total delegators</p>
          </div>
        </div>
      </div>
      <div
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic pb-[22px] pt-3 px-3 relative text-left text-nowrap w-full">
          ...
          <div className="font-['Open_Sauce_Two:Medium',_sans-serif] mb-[-10px] relative shrink-0 text-[12px] text-[rgba(255,255,255,0.48)]">
            <p className="block leading-[24px] text-nowrap whitespace-pre">Participation</p>
          </div>
        </div>
      </div>
      <div
...
function DashboardInfo10() {
  return (
    <div className="bg-[#1b1b1b] relative rounded-2xl shrink-0 w-[598px]" data-name="dashboard_info">
      <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start overflow-clip px-5 py-4 relative w-[598px]">
        ...
        <div className="font-['Open_Sauce_Two:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[15px] text-left w-full">
          <p className="block leading-[24px]">
            Biompatible approach, in which now XC-20s are actual ERC-20 tokens with EVM bytecode, the XCM fee approach
            was changed to use a we.
          </p>
        </div>
        <Frame33 />
        <Frame24 />
...
function IconButton() {
  return (
    <div className="absolute bg-[#070707] right-0 rounded-[1000px] size-10 top-0" data-name="icon_button">
      ...
      <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start overflow-clip px-5 py-4 relative w-[835px]">
        ...
        >
          <p className="block mb-0">
            Hello, as a Senior Ambassador for the Francophone community of the Moonbeam project for the past two years,
            I have a deep affection for the Polkadot ecosystem, and I am convinced of its multi-chain and
            multi-community future. My participation in the delegation program stems from my strong belief in the
            importance of governance within Moonbeam. Through your delegations, we can ensure together that Moonbeam
            remains firmly anchored on the path to success
          </p>
          <p className="block mb-0">&nbsp;</p>
          <p className="block">Feel free to contact me directly on my networks</p>
        </div>
        <Frame50 />
        <Frame36 />
        <Frame37 />
